...
def _post_generate(api_base_url: str, instruction: str, timeout_s: int = 180) -> Tuple[str, str]:
    ...
    try:
        ...
        # Ignore health errors — server may not expose /health or may be starting up.
        pass
...
EXAMPLE_INSTRUCTIONS = [
    ...
    "Virtual machines should have disk encryption enabled",
    "Web apps should require HTTPS only",
...
def build_ui() -> gr.Blocks:
    ...
    with gr.Blocks() as demo:
        ...
        example_picker = gr.Dropdown(
            choices=EXAMPLE_INSTRUCTIONS,
            label="Example instructions (select to auto-fill)",
            value=None,
        ...
        # Selecting an example auto-populates the instruction textbox
